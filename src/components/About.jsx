  ...
  return (
    <div id="about" className="border-b border-neutral-900 pb-4">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-center">
            <motion.div whileInView={{opacity:1,x:0}} initial={{opacity:0,x:-100}} transition={{duration:0.5}} className="w-full lg:w-1/2 lg:p-8 lg:mr-8">
                <div className="flex items-center justify-center">
                    <img className="rounded-xl" src={aboutImg}  width={500} height={400} alt="about"/>
                </div>
            </motion.div>
